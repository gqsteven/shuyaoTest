...
import com.shuyao.modules.sys.dao.SysUserTokenDao;
import com.shuyao.modules.sys.entity.SysUserTokenEntity;
import com.shuyao.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl implements SysUserTokenService {
	...
	public Resp createToken(long userId) {
		...
		Resp resp = Resp.ok().put("token", token).put("expire", EXPIRE);
